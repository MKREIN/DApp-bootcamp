...
describe('Exchange', () => {
  let deployer, feeAccount, user1, user2, exchange, token1, token2;
  ...
  beforeEach(async () => {
    ...
    token2 = await Token.deploy('Spud', 'SPUD', '1000000000');
    token3 = await Token.deploy('NFL Token', 'NFL', '100000000000');
